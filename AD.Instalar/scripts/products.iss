...
[CustomMessages]
DependenciesDir=Requisitos

en.depdownload_msg=las siguientes aplicaciones deben ser instaladas previamente:%n%n%1%nDescargar e instalar?

en.depdownload_memo_title=Descargar requisitos previos

en.depinstall_memo_title=Instalar requisitos previos

en.depinstall_title=Instalando requisitos

en.depinstall_description=Favor de esperar mientras los programas son instalados.

en.depinstall_status=Instalando %1...

en.depinstall_missing=%1 Debe ser instalado previamente. Favor de instalar %1 y ejecutar nuevamente.

en.depinstall_error=Ocurrió un error mientras se instalaban los requisitos previos. Favor de instalar los requisitos previos manualmente:%n
